...
Building game-changing AI applications requires understanding both AI technology and the problem domain deeply. These are the problem domains where we have deep knowledge.
  ...
  <div class="domain-content">
    ...
    <div class="domain-pitch">
      ...
      <div class="domain-cta">
        <a href="#" data-contact-type="contact" data-subject-type="general" class="btn-unified btn-primary">
